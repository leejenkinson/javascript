...
function scope() {
    ...
    console.log(x);
    console.log(y); //doesn't print as inside block above it
}
scope();
*/
//qa functions
...
const welcome = function(name2,age,gender){
    console.log(`My name is ${name2} , I am ${age} years old and of gender ${gender}`);
}
welcome('lee',37,'male');
